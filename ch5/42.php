...
<html lang="en">
    ...
    position: 'right top'
        ...
        if (str_contains($_SERVER['HTTP_REFERER'], '42update.php')) {
            alert('success', 'Data Upadatd');
        }
        if (str_contains($_SERVER['HTTP_REFERER'], '40.php')) {
            alert('success', 'Data Inserted');
        }
        if (str_contains($_SERVER['HTTP_REFERER'], '42delete.php')) {
...
<!-- /info -->
 ...
 <td> <?php echo $result['mob_no'];  ?> </td>
  <!--info not in 42 -->
 <td>  <a href="42delete.php?cust_no=<?php echo $result['cust_no']; ?>" class="text-white"> <button class="btn-danger btn">Delete</button> </a>   </td>
 <td>  <a href="42update.php?cust_no=<?php echo $result['cust_no']; ?>" class="text-white"><button class="btn-primary btn"> Update </button></a>  </td>
<!-- /info -->
 </tr>
 <?php 
 }
