            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.php#contactUs" tabindex="-1" aria-disabled="true">Contacts</a>

                        </li>
                    </ul>
                    <form class="form-inline my-2 my-lg-0 call-me-form" method="post" action="login.php" autocomplete="off">
                ...
                <div class="col-6 offset-3 login-container"><!--offset-3 moves .col-6 over three columns-->
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="sign-in" role="tabpanel"
                            ...
                            <form class="sign-in-form" method="post" action="routes/logeddata.php" autocomplete="off">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="email-request-form" method="post" action="routes/home.php">
                        <div class="form-group">
